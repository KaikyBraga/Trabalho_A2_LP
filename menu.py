...
class Menu:
    ...
    def jogar(self):
        ...
        elif personagem_selecionado == "Cavaleiro":
            personagem_selecionado = 2
        elif personagem_selecionado == "Guerreira":
            personagem_selecionado = 3
        elif personagem_selecionado == "Guerreiro":
            personagem_selecionado = 4
        loop_jogo(personagem_selecionado)
        pygame.mixer.music.load(som_menu)
        pygame.mixer.music.play(-1)
